...
global spc parameter_collection
...
if parameter_collection==1
    global betahats lifetimes_collection photoncounts mean_tau empirical_lft
    betahats=[betahats betahat]; 
    photoncount=PhotonCount;
    photoncounts=[photoncounts photoncount];
    lifetime_single=spc.lifetimes{1}/photoncount;
    lifetimes_collection=[lifetimes_collection;lifetime_single];
    mean_tau=[mean_tau spc.fits{1}.avgTau];
    empirical_lft=[empirical_lft spc.fits{1}.avgTauTrunc];
end

 % added to collect fitting parameters, 04/02/21 PM
% added to collect fitting parameters, 04/02/21 PM
% % 
% % next session added to collect fluorescence histogram properties imaged PM
