...
%  see modifications also to spc_adjustTauOffset
    ...
    % of the histogram to around 8.8 ns (8.7950 ns) after peak (180 channels) 
    % Pingchuan added 06.28.21
    lft_points=[1:1:180]*nsPerPoint;
    peak_point=find(spc.lifetimes{chan}==max(spc.lifetimes{chan}));
    empirical_lifetimes=spc.lifetimes{chan}(peak_point:(peak_point+179));
