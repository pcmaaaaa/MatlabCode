...
if parameter_collection==1 % added to collect fitting parameters, 04/02/21 PM
    global chisqs Acq_nums 
    chisqs=[chisqs redchisq];
    Acq_nums=[Acq_nums str2num(spc.filename(end-6:end-4))]; % added to collect fitting parameters
end
