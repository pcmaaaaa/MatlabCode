...
if strcmp(legend_type,'day')==1
    for i=1:length(legend_mark)
        if legend_mark(i)==1
            ...
            if(i==12)
                legend_label{counter}='reward omission day';
            elseif i==13
...
elseif strcmp(legend_type,'group_day+3')==1 %including reward omission trials
    for i=1:5
        if(legend_mark(i)==1)
            counter=counter+1;
            ...
            elseif i==4
                ...
                legend_label{counter}=['LED omission trials'];
            end
        end
    end
