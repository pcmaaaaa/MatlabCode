function [dtau,photoncount,time] = align_FLIM_signal3(FLPdata_time, FLPdata_lifetimes, eventtime,duration,baseline_duration,timebin,ch,baseline_tau_duration)
...
for i=idx_start:idx_end-1
    ...
    baseline_taus=[baseline_taus,spc_calculateAvgTau(ch)];
end
