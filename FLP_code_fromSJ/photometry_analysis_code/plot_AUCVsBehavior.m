function plot_AUCVsBehavior(data,data_list,num_days,behavior,search_duration,eventtime,inputrate,timebin,plottitle)
...
%plot DA signal aligned to dispensing vs. latency
x=[];
y=[];
for d=data_list
    for i=2:num_days
