...
% Last Modified by GUIDE v2.5 04-Jul-2018 15:34:09
...
% --- Executes on button press in endAcq.
function endAcq_Callback(hObject, eventdata, handles)
% hObject    handle to endAcq (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
if timerGetPackageStatus('zFLP')==1
    global testTimer state
...
if timerGetPackageStatus('Physiology')==1
    phGrabButtonPressed;
end

%timerCallPackageFunctions('Abort');
display('*** data collection manually ended');
