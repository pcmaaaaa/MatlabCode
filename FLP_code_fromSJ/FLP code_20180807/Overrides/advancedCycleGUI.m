...
% Last Modified by GUIDE v2.5 05-Jan-2017 08:28:45
...
%	set(h, 'Enable', 'off');
	...
	try
		...
		if isempty(guiOrder) || ~iscell(guiOrder)
			guiOrder={'repeats', 'delay', 'frames', 'blaster', 'imageOn', 'physOn', 'tracker', 'avgFrames', 'linescan', 'da0', 'da1', 'aux4', 'aux5', 'aux6', 'aux7','photometryOn','totalAcqTime','sliceTime','sequencer','trigger','syncPhys'};
		end
		...
		if isnumeric(getfield(state.cycle, tag)) %update state.cycle.'...List'
		...
		if any(p) 
			...
			eval(['uicontrol(gh.advancedCycleGui.' guiOrder{p} ');']); %uicontrol creates a uicontrol (push button) in the current figure and returns the uicontrol object
		end
...
% --- Executes on button press in sequencer.
function sequencer_Callback(hObject, eventdata, handles)
% hObject    handle to sequencer (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)

% Hint: get(hObject,'Value') returns toggle state of sequencer
...
% --- Executes on button press in photometryOn.
function photometryOn_Callback(hObject, eventdata, handles)
% hObject    handle to photometryOn (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)

% Hint: get(hObject,'Value') returns toggle state of photometryOn


% --- Executes on button press in syncPhys.
function syncPhys_Callback(hObject, eventdata, handles)
% hObject    handle to syncPhys (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)

% Hint: get(hObject,'Value') returns toggle state of syncPhys
...
function totalAcqTime_Callback(hObject, eventdata, handles)
% hObject    handle to totalAcqTime (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)

% Hints: get(hObject,'String') returns contents of totalAcqTime as text
%        str2double(get(hObject,'String')) returns contents of totalAcqTime as a double


% --- Executes during object creation, after setting all properties.
function totalAcqTime_CreateFcn(hObject, eventdata, handles)
% hObject    handle to totalAcqTime (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    empty - handles not created until after all CreateFcns called
...
% --- Executes on slider movement.
function totalAcqTimeSlider_Callback(hObject, eventdata, handles)
% hObject    handle to totalAcqTimeSlider (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
...
% --- Executes during object creation, after setting all properties.
function totalAcqTimeSlider_CreateFcn(hObject, eventdata, handles)
% hObject    handle to totalAcqTimeSlider (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    empty - handles not created until after all CreateFcns called
...
function sliceTime_Callback(hObject, eventdata, handles)
% hObject    handle to sliceTime (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)

% Hints: get(hObject,'String') returns contents of sliceTime as text
%        str2double(get(hObject,'String')) returns contents of sliceTime as a double


% --- Executes during object creation, after setting all properties.
function sliceTime_CreateFcn(hObject, eventdata, handles)
% hObject    handle to sliceTime (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    empty - handles not created until after all CreateFcns called
...
% --- Executes on slider movement.
function sliceTimeSlider_Callback(hObject, eventdata, handles)
% hObject    handle to sliceTimeSlider (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
...
% --- Executes during object creation, after setting all properties.
function sliceTimeSlider_CreateFcn(hObject, eventdata, handles)
% hObject    handle to sliceTimeSlider (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    empty - handles not created until after all CreateFcns called
...
% --- Executes during object creation, after setting all properties.
function repeatOutput_CreateFcn(hObject, eventdata, handles)
% hObject    handle to repeatOutput (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    empty - handles not created until after all CreateFcns called
...
% --- Executes during object creation, after setting all properties.
function repeatOutputSlider_CreateFcn(hObject, eventdata, handles)
% hObject    handle to repeatOutputSlider (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    empty - handles not created until after all CreateFcns called
