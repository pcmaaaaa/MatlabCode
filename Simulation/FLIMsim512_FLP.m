function FLIMsim512_FLP = FLIMsim512_FLP(SS, DC, afterpulse, PrfName, PopulationName, SaveName)
...
xsim2=linspace(0,75,768);
[n1, xout1]=hist(Sample, xsim2);
...
save(SaveName, 'n1','n2', 'n'); % n gives the photon count per bin; xout gives the lifetime position of each bin.
end
