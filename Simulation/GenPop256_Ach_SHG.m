function GenPop256_Ach_SHG = GenPop256_Ach_SHG(TP, p1, p2, tau1, tau2, PopulationName,prf_peak,SHG_ratio);
...
ysim(1)=ysim(1)+sum(ysim)*SHG_ratio;
%   Shift y axis to the right to match prf shape.
% ysimo(1:52)=ysim(205:256);
% ysimo(53:256)=ysim(1:204);

ysimo(1:prf_peak-1)=ysim(258-prf_peak:256);
ysimo(prf_peak:256)=ysim(1:257-prf_peak);
% figure; 
% plot(xsim, ysimo);
