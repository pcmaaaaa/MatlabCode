function FLIMsim256 = FLIMsim256_FLP(SS, DC, afterpulse, PopulationName, SaveName)
global Gaussian_y;
...
save(SampleName, 'n1','n2', 'n'); % n gives the photon count per bin; xout gives the lifetime position of each bin.
end
